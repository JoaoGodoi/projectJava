...
public class f_login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(Autentica()){
            try {
                Usuario u = UsuarioDAO.getInstance().LoginUsuario(txtUsername.getText(), UsuarioDAO.SenhaMD5(txtSenha.getText()));
                if(u == null)
                    ...
                    //xvideos.com/&cat=porno_de_anao_com_hentai_gay&pag=12
                }
            } catch (Exception e) {}
        }
